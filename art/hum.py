...
That's not a claim about the passes. It's a choice about the tuning.
    ...
    python3 art/hum.py        # writes art/loom.wav (not committed)

The piece is exactly as long as the record.
"""
...
PENTA = [0, 3, 5, 7, 10]
OUT = Path(__file__).parent / "loom.wav"
...
if __name__ == "__main__":
    ...
    bars = len(hashes())
    print(f"  {bars} bars of 7/8 -> {OUT.name} "
